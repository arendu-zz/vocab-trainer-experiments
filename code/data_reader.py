...
def read_data(file_path, dh):
    ...
    TRAINING_SEQ = []
    prev_user = None
    X, Y, YT, O, S = None, None, None, None, None, None
    for line in data_lines:
        user, uts, ptype, tstep, a_idx, fr, en_true, en_options, en_selected, fb  = [i.strip() for i in line.split('\t')]
        if user != prev_user:
        ...
        if en_selected != "NO_ANSWER_MADE":
            ...
            t = np.array([0,0,0,0,0,0,0]).astype(intX)
